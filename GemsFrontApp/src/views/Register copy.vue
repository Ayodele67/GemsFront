...
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
       <BaseInput name="name" v-model="name" label="First Name" success />
       <BaseInput name="lastname" v-model="lastname" label="Last Name" success />
      <div class="sm:col-span-2">
        <BaseInput name="company" v-model="company" label="Company" success />
      </div>
      <div class="sm:col-span-2">
        <BaseInput name="email" v-model="email" label="Email Address" success />
      </div>
      <div class="sm:col-span-2">
